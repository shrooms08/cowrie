...
impl CircomGroth16Verifier {
    ...
    /// CLI-friendly entrypoint: proof as 256 raw bytes (A‖B‖C, B in c1‖c0),
    /// public inputs as concatenated 32-byte big-endian field elements.
    pub fn verify_bytes(
        env: Env,
        proof: soroban_sdk::Bytes,
        public_inputs: soroban_sdk::Bytes,
    ) -> Result<bool, Groth16Error> {
        let proof = Groth16Proof::try_from(proof)?;
        ...
        let vk = embedded_vk(&env);
        Self::verify_with_vk(&env, &vk, proof, pubs)
    }
